...
keywords: ["historia del cajero automático", "primer cajero automático del mundo", "por qué no confío en las wallets cripto", "desconfianza ante tecnología nueva ejemplos históricos", "adopción de tecnología bancaria historia"]
description: "El primer cajero automático generó la misma desconfianza que hoy sienten algunos frente a una wallet no custodial — la misma reacción, sesenta años antes, con otro nombre."
image: "/assets/blog/cajero-automatico-wallet.webp"
image_alt: "Ilustración conceptual de un cajero automático antiguo junto a una wallet digital, representando la misma desconfianza histórica"
---
...
Tres formas de seguir desde aquí, según en dónde te encuentres tú con esa idea: revisar el catálogo completo de este mismo patrón a lo largo de la historia en [El Patrón](/infografia), donde están las seis revoluciones tecnológicas documentadas desde 1837; releer el post de wallet no custodial con esta comparación en mente, a ver si cambia algo de cómo lo entiendes; o, si ya tienes una pregunta concreta sobre a quién le reclamas en un sistema sin intermediario, platicarlo directamente.
